...
@Path("/attraction")
@Api(value = "/attraction", description = "Operations about attractions")
...
public class AttractionController {
	...
	private String getTableName(String language) throws LanguageNotSupportException
	{
		if(language == null)
			language = "zh_tw";
		String tablename = "place_zh_tw";
		switch(language)
		{
		case "en_us":
			tablename = "place_en_us";
			break;
		case "zh_tw":
			tablename = "place_zh_tw";
			break;
		case "ja_jp":
			tablename = "place_ja_jp";
			break;
		default:
	...
	@GET
	@Path("/{id}")
	@ApiOperation(value = "Get the attraction infomation by ID", response = Attraction.class)
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public Attraction GETAttractionByID(@PathParam("id") String id,
		...
		Attraction r = AttractionHydrator.fromResultSet(result);
		pst.close();
		return r;
	}
	...
	@GET
	@Path("/findByCounty")
	@ApiOperation(value = "Get the attractions infomation by county id", response = Attraction.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Attraction> GETAttractionsByCounty(
		...
		ResultSet result = pst.executeQuery();
		List<Attraction> r = Linq4j.asEnumerable(AttractionHydrator.fromResultSettoList(result)).where(new Predicate1<Attraction>() {
			
			@Override
			public boolean apply(Attraction arg0) {
	...
	@GET
	@Path("/findTopTen")
	@ApiOperation(value = "Get Top 10 attractions infomation", response = Attraction.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Attraction> GETAttractionsByTopTen(
			@ApiParam(allowableValues = "zh_tw,en_us,ja_jp")@HeaderParam("language") String language) throws Exception {
		String TN = getTableName(language);
		Connection con = DbUtil.getConnection();
		PreparedStatement pst = con.prepareStatement(
		...
		ResultSet result = pst.executeQuery();
		return AttractionHydrator.fromResultSettoList(result);
	}

	@GET
	@Path("/findByTheme")
	@ApiOperation(value = "Get the attractions infomation by theme class id", response = Attraction.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Attraction> GETAttractionsByTheme(
	...
	@GET
	@Path("/findByCriteria")
	@ApiOperation(value = "Get the attractions infomation by some criterias", response = Attraction.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Parameter") 
			})
	public List<Attraction> GETAttractionsByCriteria(
	...
	@GET
	@Path("/findByNearBy")
	@ApiOperation(value = "Get the attractions infomation by nearby location", response = Attraction.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Attraction> GETAttractionsByNearBy(
	...
	@GET
	@Path("/findByRank")
	@ApiOperation(value = "Get the attractions infomation by rank", response = Attraction.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Attraction not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Attraction> GETAttractionsByRank(
