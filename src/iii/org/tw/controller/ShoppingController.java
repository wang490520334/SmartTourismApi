...
import iii.org.tw.hydrator.ShoppingHydrator;
...
@Path("/shopping")
@Api(value = "/shopping", description = "Operations about shoppings")
...
public class ShoppingController {
	...
	private String getTableName(String language) throws LanguageNotSupportException
	{
		if(language == null)
			language = "zh_tw";
		String tablename = "souvenirs_zh_tw";
		switch(language)
		{
		case "en_us":
			tablename = "souvenirs_en_us";
			break;
		case "zh_tw":
			tablename = "souvenirs_zh_tw";
			break;
		case "ja_jp":
			tablename = "souvenirs_ja_jp";
			break;
		default:
	...
	@GET
	@Path("/{id}")
	@ApiOperation(value = "Get the shopping infomation by ID", response = Shopping.class)
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public Shopping GETShoppingByID(@PathParam("id") String id,
		...
		return ShoppingHydrator.fromResultSet(result);
	}

	@GET
	@Path("/findByCounty")
	@ApiOperation(value = "Get the shoppings infomation by county id", response = Shopping.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Shopping> GETShoppingsByCounty(
		...
		ResultSet result = pst.executeQuery();
		return Linq4j.asEnumerable(ShoppingHydrator.fromResultSettoList(result)).where(new Predicate1<Shopping>() {
			
			@Override
			public boolean apply(Shopping arg0) {
	...
	@GET
	@Path("/findTopTen")
	@ApiOperation(value = "Get Top 10 shoppings infomation", response = Shopping.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Shopping> GETShoppingsByTopTen(
			@ApiParam(allowableValues = "zh_tw,en_us,ja_jp")@HeaderParam("language") String language) throws Exception {
		String TN = getTableName(language);
		Connection con = DbUtil.getConnection();
		PreparedStatement pst = con.prepareStatement(
		...
		ResultSet result = pst.executeQuery();
		return ShoppingHydrator.fromResultSettoList(result);
	}

	@GET
	@Path("/findByTheme")
	@ApiOperation(value = "Get the shoppings infomation by theme class id", response = Shopping.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Shopping> GETShoppingsByTheme(
	...
	@GET
	@Path("/findByCriteria")
	@ApiOperation(value = "Get the shoppings infomation by some criterias", response = Shopping.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Parameter") 
			})
	public List<Shopping> GETShoppingsByCriteria(
	...
	@GET
	@Path("/findByNearBy")
	@ApiOperation(value = "Get the shoppings infomation by nearby location", response = Shopping.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Shopping> GETShoppingsByNearBy(
	...
	@GET
	@Path("/findByRank")
	@ApiOperation(value = "Get the shoppings infomation by rank", response = Shopping.class, responseContainer = "List")
	@ApiResponses(value = {
			  @ApiResponse(code = 500, message = "Internal Error"),
			  @ApiResponse(code = 404, message = "Shopping not found"),
			  @ApiResponse(code = 400, message = "Invalid Language String") 
			})
	public List<Shopping> GETShoppingsByRank(
