...
public class ShoppingHydrator {

	public static Properties props = new Properties();

	static {
		try {
			props.load(ShoppingHydrator.class
	...
	private static Shopping hydrator(ResultSet result) throws SQLException
	{
		Shopping att = new Shopping();
		...
		att.setShareUrl(props.getProperty("share.url.bath") + props.getProperty("share.url.Shopping") + result.getString("Place_Id"));
	...
	public static Shopping fromResultSet(ResultSet result) throws SQLException, NotFoundException
	{
		if(result.first())
	...
	public static List<Shopping> fromResultSettoList(ResultSet result) throws NotFoundException, SQLException
	{
		ArrayList<Shopping> results = new ArrayList<Shopping>();
		while (result.next()) {
