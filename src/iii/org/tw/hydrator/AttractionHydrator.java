...
public class AttractionHydrator {

	public static Properties props = new Properties();

	static {
		try {
			props.load(AttractionHydrator.class
	...
	private static Attraction hydrator(ResultSet result) throws SQLException
	{
		...
		att.setShareUrl(props.getProperty("share.url.bath") + props.getProperty("share.url.Attraction") + result.getString("Place_Id"));
	...
	public static Attraction fromResultSet(ResultSet result) throws SQLException, NotFoundException
	{
		if(result.first())
	...
	public static List<Attraction> fromResultSettoList(ResultSet result) throws NotFoundException, SQLException
	{
