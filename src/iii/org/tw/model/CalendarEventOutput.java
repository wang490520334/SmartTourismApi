...
public class CalendarEventOutput {
    ...
    private List<PoiEventIOModel> Event_Poi ;     
    private String Notice ;    
    private Integer Remind ;
    
   
	public CalendarEventOutput(String event_Id, String event_Type,
			String event_Title, String start_Time, String end_Time,
			List<PoiEventIOModel> event_Poi, String notice, Integer remind) {
		super();
		Event_Id = event_Id;
	...
	public List<PoiEventIOModel> getEvent_Poi() {
		return Event_Poi;
	}

	public void setEvent_Poi(List<PoiEventIOModel> event_Poi) {
		Event_Poi = event_Poi;
	}
